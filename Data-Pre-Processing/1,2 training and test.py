...
# Início do teste e treinamento para o crédito
...
print(x_credito_treinamento.shape) #printa a quantidade de registros 0.75 do banco 1500 linhas e 3 colunas
print(y_credito_treinamento.shape)
print(x_credito_teste.shape) #printa a quantidade de registros 0.25 do banco 1500 linhas e 3 colunas
print(y_credito_teste.shape)

# Início do teste e treinamento para o censo
...
print(x_censo_treinamento.shape) #printa a quantidade de registros 0.85 do banco
print(y_censo_treinamento.shape)
print(x_censo_teste.shape) #printa a quantidade de registros 0.15 do banco
print(y_censo_teste.shape)

# Usar sempre menos no teste e mais no treinamento